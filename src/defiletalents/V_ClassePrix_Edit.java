...
/**
 * Classe permettant de gérer la vue relative à un enregistrement de la table tal_classe_prix.
 * @author giraudeaup
 */
public class V_ClassePrix_Edit extends javax.swing.JDialog
{
     ...
     * @param controller 
     */
    public V_ClassePrix_Edit(Controller controller)
    {
    ...
    {//GEN-HEADEREND:event_btValiderActionPerformed
        ...
        {
            controller.updateClassePrix(id, edLibelle.getText());
    ...
    /**
     * Surcharge la méthode setVisible(boolean b).
     * @param b 
     */
    @Override
    public void setVisible(boolean b)
    {
        if (b)
        {
            setLocationRelativeTo(controller.getClassePrixAllFrame());
            lbWarning.setText("");
        }
    ...
    /**
     * Met à jour les valeurs à utiliser pour la vue.
     * @param id
     * @param libelle
     * @param mode 
     */
    public void setValues(int id, String libelle, int mode)
    {
        ...
        switch (mode)
        {
            case V_Main.MODE_AJOUT:
                setTitle("Ajout d'une nouvelle classe de prix");
                edLibelle.setText("");
                break;
            case V_Main.MODE_EDITION:
                setTitle("Edition de la classe de prix " + id);
                edLibelle.setText(libelle);
                break;
            default:
                setTitle("Consultation de la classe de prix " + id);
                edLibelle.setText(libelle);
