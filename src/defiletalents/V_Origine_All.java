...
/**
 * Classe permettant de gérer la vue relative à la table tal_origine.
 *
 * @author giraudeaup
 */
public class V_Origine_All extends javax.swing.JFrame {
     ...
     * @param controller
     */
    public V_Origine_All(Controller controller) {
        this.controller = controller;
        initComponents();
        setTitle("Paramètres > Origines");
    }
    ...
    private void initComponents()
    {
        ...
        tableOrigines = new javax.swing.JTable();
        ...
        tableOrigines.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][]
            {
                {null, null, null}
            },
        ...
        jScrollPane1.setViewportView(tableOrigines);
        if (tableOrigines.getColumnModel().getColumnCount() > 0)
        {
            tableOrigines.getColumnModel().getColumn(0).setMinWidth(0);
            tableOrigines.getColumnModel().getColumn(0).setPreferredWidth(0);
            tableOrigines.getColumnModel().getColumn(0).setMaxWidth(0);
            tableOrigines.getColumnModel().getColumn(1).setMinWidth(90);
            tableOrigines.getColumnModel().getColumn(1).setPreferredWidth(90);
            tableOrigines.getColumnModel().getColumn(1).setMaxWidth(150);
        }
    ...
    {//GEN-HEADEREND:event_btAddActionPerformed
        controller.getOriginesEditFrame(V_Main.MODE_AJOUT).setVisible(true);
    ...
    {//GEN-HEADEREND:event_btEditActionPerformed
        if (tableOrigines.getSelectedRow() != -1) {
            controller.getOriginesEditFrame((int) tableOrigines.getValueAt(tableOrigines.getSelectedRow(), 0), V_Main.MODE_EDITION).setVisible(true);
        }
    ...
    {//GEN-HEADEREND:event_btDelActionPerformed
        if (tableOrigines.getSelectedRow() != -1) {
            controller.getDeleteConfirmFrame("origine", String.valueOf((int) tableOrigines.getModel().getValueAt(tableOrigines.getSelectedRow(), 0))).setVisible(true);
        }
    ...
    private void setTable() {
        DefaultTableModel model = (DefaultTableModel) tableOrigines.getModel();
        int size = controller.getOrigines().size();
        ...
        for (M_Origine o : controller.getOrigines()) {
            model.setValueAt(o.getId(), i, 0);
            model.setValueAt(o.getCode(), i, 1);
            model.setValueAt(o.getLibelle(), i, 2);
            i++;
        }
        tableOrigines.setModel(model);
    ...
    private javax.swing.JTable tableOrigines;
