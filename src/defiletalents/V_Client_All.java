...
/**
 * Classe permettant de gérer la vue relative à la table tal_client.
 * @author giraudeaup
 */
public class V_Client_All extends javax.swing.JFrame
{
     ...
     */
    private CopyOnWriteArrayList<M_Client> results;

    /**
     * Constructeur de la vue.
     * @param controller 
     */
    public V_Client_All(Controller controller)
    {
    ...
    private void initComponents()
    {
        ...
        tableClients.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "Id", "Nom", "Prénom", "Lieu dit", "Code Origine"
            }
        )
        {
        ...
        btDel.setMaximumSize(new java.awt.Dimension(160, 27));
        btDel.setMinimumSize(new java.awt.Dimension(160, 27));
    ...
    {//GEN-HEADEREND:event_btAddActionPerformed
        controller.getClientEditFrame(V_Main.MODE_AJOUT, null).setVisible(true);
    ...
    {//GEN-HEADEREND:event_btEditActionPerformed
        ...
        {
            controller.getClientEditFrame((int) tableClients.getModel().getValueAt(tableClients.getSelectedRow(), 0), V_Main.MODE_EDITION, null).setVisible(true);
        }
    ...
    {//GEN-HEADEREND:event_btDelActionPerformed
        if (tableClients.getSelectedRow() != -1)
        {
            controller.getDeleteConfirmFrame("Client", String.valueOf((int) tableClients.getModel().getValueAt(tableClients.getSelectedRow(), 0))).setVisible(true);
        }
    ...
    {
        CopyOnWriteArrayList<M_Client> clients = (recherche ? Verify.trierClients(results) : Verify.trierClients(controller.getClients()));
        ...
        for (M_Client c : clients)
        {
            ...
            model.setValueAt(c.getNom(), i, 1);
            model.setValueAt(c.getPrenom(), i, 2);
            model.setValueAt(c.getLieuDit(), i, 3);
            origine = ((controller.getOrigine(c.getIdOrigine()) != null) ? controller.getOrigine(c.getIdOrigine()).getCode() : "null");
            model.setValueAt(origine, i, 4);
            i++;
        }
    ...
    /**
     * Passe la fenêtre en mode recherche.
     * Valorise la collection concernant les résultats de la recherche.
     * @param recherche
     * @param results 
     */
    public void rechercheMode(boolean recherche, CopyOnWriteArrayList<M_Client> results)
    {
